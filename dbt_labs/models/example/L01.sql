...
$$
BEGIN
IF $1.area_code=$2.area_code AND
$1.line_number=$2.line_number THEN
RETURN TRUE ;
ELSE
END IF;
END;
...
LANGUAGE plsql;
CREATE OPERATOR = (
LEFTWARD = phone_number,
RIGHTWARD = phone_number,
PROCEDURE = phone_number_equal
);
--For test purpose
SELECT row('123','222244')::phone_number =
row('1','222244')::phone_number;